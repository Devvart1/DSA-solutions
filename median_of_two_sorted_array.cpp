...
/*--------------------------------------------------------------------------------------------------------------------------*/
int l1, l2, r1, r2, low, high, mid, n, m;
l1 = r1 = INT_MIN;
l2 = r2 = INT_MAX;
bool check(vector<int>& nums1, vector<int>& nums2, int mid) {
  ...
  r1 = (n + m) / 2 - mid - 1;
  r2 = m - r1 - 1;
  if (nums1[l1] <= nums2[r2] and nums1[l2] >= nums2[r1]) {
    return true;
    return false;
  }
}
double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2) {
  ...
  while (low <= high) {
    ...
    {
      return (double)(max(nums1[l1], nums2[r1]) + min(nums1[l2], nums2[r2])) / 2;
    }
